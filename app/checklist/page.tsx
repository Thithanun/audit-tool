...
// Parse "9:00-10:00", "09:00", "10.00-11.00" → minutes since midnight for numeric sort.
// Avoids the string-sort trap where "10:00" < "9:00".
...
export default function ChecklistPage() {
  ...
  // Filter out general/non-clause sessions, then sort by date → day → start time.
  // We re-sort here (in addition to getPlanSessions) to guarantee dropdown order
  // is correct regardless of any intermediate state transformations.
        ...
        {canEdit && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="border border-slate-300 text-slate-700 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed text-sm font-medium px-4 py-2 rounded-lg transition-colors flex items-center gap-2"
            >
