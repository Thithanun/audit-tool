...
export const ISMS_CLAUSES: ClauseTemplate[] = [
  // Clause 4 – Context of the organization
  { clauseRef: '4.1', clauseTitle: 'Understanding the organization and its context', framework: 'ISO27001', requirement: 'The organization shall determine external and internal issues that are relevant to its purpose and that affect its ability to achieve the intended outcome(s) of its information security management system.' },
  { clauseRef: '4.2', clauseTitle: 'Understanding the needs and expectations of interested parties', framework: 'ISO27001', requirement: 'The organization shall determine the interested parties that are relevant to the ISMS and the requirements of those interested parties relevant to information security, and which of these requirements will be addressed through the ISMS.' },
  { clauseRef: '4.3', clauseTitle: 'Determining the scope of the ISMS', framework: 'ISO27001', requirement: 'The organization shall determine the boundaries and applicability of the ISMS to establish its scope, taking into account the external and internal issues, the requirements of interested parties, and interfaces and dependencies between activities performed by the organization and those performed by other organizations.' },
  { clauseRef: '4.4', clauseTitle: 'Information security management system', framework: 'ISO27001', requirement: 'The organization shall establish, implement, maintain and continually improve an information security management system, including the processes needed and their interactions, in accordance with the requirements of ISO 27001.' },

  // Clause 5 – Leadership
  { clauseRef: '5.1', clauseTitle: 'Leadership and commitment', framework: 'ISO27001', requirement: 'Top management shall demonstrate leadership and commitment with respect to the ISMS by ensuring that the information security policy and objectives are established and are compatible with the strategic direction of the organization, and by ensuring the integration of the ISMS requirements into the organization\'s processes.' },
  { clauseRef: '5.2', clauseTitle: 'Policy', framework: 'ISO27001', requirement: 'Top management shall establish an information security policy that is appropriate to the purpose of the organization, includes information security objectives or provides the framework for setting them, includes a commitment to satisfy applicable requirements, and includes a commitment to continual improvement of the ISMS.' },
  { clauseRef: '5.3', clauseTitle: 'Organizational roles, responsibilities and authorities', framework: 'ISO27001', requirement: 'Top management shall ensure that the responsibilities and authorities for roles relevant to information security are assigned and communicated within the organization, including responsibility for ensuring the ISMS conforms to requirements and reporting on ISMS performance to top management.' },

  // Clause 6 – Planning
  { clauseRef: '6.1.1', clauseTitle: 'Actions to address risks and opportunities – General', framework: 'ISO27001', requirement: 'When planning for the ISMS, the organization shall consider the issues and requirements referred to in Clauses 4.1 and 4.2 and determine the risks and opportunities that need to be addressed to ensure the ISMS can achieve its intended outcome(s), prevent or reduce undesired effects, and achieve continual improvement.' },
  { clauseRef: '6.1.2', clauseTitle: 'Information security risk assessment', framework: 'ISO27001', requirement: 'The organization shall define and apply an information security risk assessment process that establishes and maintains information security risk criteria, ensures repeated assessments produce consistent, valid and comparable results, identifies and analyses information security risks, and evaluates them against the established criteria.' },
  { clauseRef: '6.1.3', clauseTitle: 'Information security risk treatment', framework: 'ISO27001', requirement: 'The organization shall define and apply an information security risk treatment process to select appropriate risk treatment options, determine all controls necessary to implement the chosen treatment options, and produce a Statement of Applicability and an information security risk treatment plan.' },
  { clauseRef: '6.2', clauseTitle: 'Information security objectives', framework: 'ISO27001', requirement: 'The organization shall establish information security objectives at relevant functions and levels; the objectives shall be consistent with the information security policy, measurable, monitored, communicated and updated as appropriate, and shall be documented.' },
  { clauseRef: '6.3', clauseTitle: 'Planning of changes', framework: 'ISO27001', requirement: 'When the organization determines the need for changes to the ISMS, the changes shall be carried out in a planned manner.' },

  // Clause 7 – Support
  { clauseRef: '7.1', clauseTitle: 'Resources', framework: 'ISO27001', requirement: 'The organization shall determine and provide the resources needed for the establishment, implementation, maintenance and continual improvement of the ISMS.' },
  { clauseRef: '7.2', clauseTitle: 'Competence', framework: 'ISO27001', requirement: 'The organization shall determine the necessary competence of persons doing work under its control that affects information security performance, ensure those persons are competent, and retain appropriate documented information as evidence of competence.' },
  { clauseRef: '7.3', clauseTitle: 'Awareness', framework: 'ISO27001', requirement: 'Persons doing work under the organization\'s control shall be aware of the information security policy, their contribution to the effectiveness of the ISMS including the benefits of improved information security performance, and the implications of not conforming to the ISMS requirements.' },
  { clauseRef: '7.4', clauseTitle: 'Communication', framework: 'ISO27001', requirement: 'The organization shall determine the need for internal and external communications relevant to the ISMS, including what, when, with whom, and how to communicate.' },
  { clauseRef: '7.5.1', clauseTitle: 'Documented information – General', framework: 'ISO27001', requirement: 'The organization\'s ISMS shall include documented information required by ISO 27001 and documented information determined by the organization as being necessary for the effectiveness of the ISMS.' },
  { clauseRef: '7.5.2', clauseTitle: 'Creating and updating', framework: 'ISO27001', requirement: 'When creating and updating documented information, the organization shall ensure appropriate identification and description, format and media, and review and approval for suitability and adequacy.' },
  { clauseRef: '7.5.3', clauseTitle: 'Control of documented information', framework: 'ISO27001', requirement: 'Documented information required by the ISMS and by ISO 27001 shall be controlled to ensure it is available and suitable for use where and when it is needed, and is adequately protected from loss of confidentiality, improper use, or loss of integrity.' },

  // Clause 8 – Operation
  { clauseRef: '8.1', clauseTitle: 'Operational planning and control', framework: 'ISO27001', requirement: 'The organization shall plan, implement, control, monitor and review the processes needed to meet information security requirements, and implement the actions determined in Clause 6, by establishing criteria for the processes and implementing control of the processes in accordance with the criteria.' },
  { clauseRef: '8.2', clauseTitle: 'Information security risk assessment', framework: 'ISO27001', requirement: 'The organization shall perform information security risk assessments at planned intervals or when significant changes are proposed or occur, and retain documented information of the results.' },
  { clauseRef: '8.3', clauseTitle: 'Information security risk treatment', framework: 'ISO27001', requirement: 'The organization shall implement the information security risk treatment plan and retain documented information of the results of the risk treatment.' },

  // Clause 9 – Performance evaluation
  { clauseRef: '9.1', clauseTitle: 'Monitoring, measurement, analysis and evaluation', framework: 'ISO27001', requirement: 'The organization shall evaluate the information security performance and the effectiveness of the ISMS, determining what needs to be monitored and measured, the methods for analysis and evaluation, when monitoring and measurement shall be performed, and who shall do so.' },
  { clauseRef: '9.2.1', clauseTitle: 'Internal audit – General', framework: 'ISO27001', requirement: 'The organization shall conduct internal audits at planned intervals to provide information on whether the ISMS conforms to the organization\'s own requirements and to ISO 27001 requirements, and is effectively implemented and maintained.' },
  { clauseRef: '9.2.2', clauseTitle: 'Internal audit programme', framework: 'ISO27001', requirement: 'The organization shall plan, establish, implement and maintain an audit programme including the frequency, methods, responsibilities, planning requirements and reporting, taking into consideration the importance of the processes concerned and the results of previous audits.' },
  { clauseRef: '9.3.1', clauseTitle: 'Management review – General', framework: 'ISO27001', requirement: 'Top management shall review the organization\'s ISMS at planned intervals to ensure its continuing suitability, adequacy and effectiveness.' },
  { clauseRef: '9.3.2', clauseTitle: 'Management review inputs', framework: 'ISO27001', requirement: 'The management review shall consider the status of actions from previous management reviews, changes in external and internal issues relevant to the ISMS, feedback on information security performance including trends in nonconformities, monitoring and measurement results, audit results, and fulfilment of information security objectives.' },
  { clauseRef: '9.3.3', clauseTitle: 'Management review results', framework: 'ISO27001', requirement: 'The results of the management review shall include decisions related to continual improvement opportunities and any need for changes to the ISMS; the organization shall retain documented information as evidence of the results of management reviews.' },

  // Clause 10 – Improvement
  { clauseRef: '10.1', clauseTitle: 'Continual improvement', framework: 'ISO27001', requirement: 'The organization shall continually improve the suitability, adequacy and effectiveness of the information security management system.' },
  { clauseRef: '10.2', clauseTitle: 'Nonconformity and corrective action', framework: 'ISO27001', requirement: 'When a nonconformity occurs, the organization shall react to the nonconformity, evaluate the need for action to eliminate the causes so that it does not recur or occur elsewhere, implement any action needed, and review the effectiveness of any corrective action taken.' },
];
...
export const ISO27001_CLAUSES: ClauseTemplate[] = [
  ...
  { clauseRef: 'A.7.1',  clauseTitle: 'Physical security perimeters',                    framework: 'ISO27001', requirement: 'Security perimeters shall be defined and used to protect areas that contain information and other associated assets.' },
  { clauseRef: 'A.7.2',  clauseTitle: 'Physical entry',                                   framework: 'ISO27001', requirement: 'Secure areas shall be protected by appropriate entry controls and access points to ensure that only authorized personnel are allowed access.' },
  { clauseRef: 'A.7.3',  clauseTitle: 'Securing offices, rooms and facilities',           framework: 'ISO27001', requirement: 'Physical security for offices, rooms and facilities shall be designed and implemented.' },
  { clauseRef: 'A.7.4',  clauseTitle: 'Physical security monitoring',                     framework: 'ISO27001', requirement: 'Premises shall be continuously monitored for unauthorized physical access.' },
  { clauseRef: 'A.7.5',  clauseTitle: 'Protecting against physical and environmental threats', framework: 'ISO27001', requirement: 'Protection against physical and environmental threats, such as natural disasters and other intentional or unintentional physical threats to infrastructure, shall be designed and implemented.' },
  { clauseRef: 'A.7.6',  clauseTitle: 'Working in secure areas',                          framework: 'ISO27001', requirement: 'Security measures for working in secure areas shall be designed and implemented.' },
  { clauseRef: 'A.7.7',  clauseTitle: 'Clear desk and clear screen',                      framework: 'ISO27001', requirement: 'Clear desk rules for papers and removable storage media and clear screen rules for information processing facilities shall be defined and appropriately enforced.' },
  { clauseRef: 'A.7.8',  clauseTitle: 'Equipment siting and protection',                  framework: 'ISO27001', requirement: 'Equipment shall be sited securely and protected.' },
  { clauseRef: 'A.7.9',  clauseTitle: 'Security of assets off-premises',                  framework: 'ISO27001', requirement: 'Off-site assets shall be protected.' },
  { clauseRef: 'A.7.10', clauseTitle: 'Storage media',                                    framework: 'ISO27001', requirement: 'Storage media shall be managed through their life cycle of acquisition, use, transportation and disposal in accordance with the organization\'s classification scheme and handling requirements.' },
  { clauseRef: 'A.7.11', clauseTitle: 'Supporting utilities',                             framework: 'ISO27001', requirement: 'Information processing facilities shall be protected from power failures and other disruptions caused by failures in supporting utilities.' },
  { clauseRef: 'A.7.12', clauseTitle: 'Cabling security',                                 framework: 'ISO27001', requirement: 'Cables carrying power, data or supporting information services shall be protected from interception, interference or damage.' },
  { clauseRef: 'A.7.13', clauseTitle: 'Equipment maintenance',                            framework: 'ISO27001', requirement: 'Equipment shall be maintained correctly to ensure availability, integrity and confidentiality of information.' },
  { clauseRef: 'A.7.14', clauseTitle: 'Secure disposal or re-use of equipment',           framework: 'ISO27001', requirement: 'Items of equipment containing storage media shall be verified to ensure that any sensitive data and licensed software has been removed or securely overwritten prior to disposal or re-use.' },
